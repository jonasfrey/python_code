...
class Game: 
    def __init__(self):
        ...
        def o1_render_fun(self):
            ...
            if(int(snake_head.rendered_count) % 3 == 0): snake_head.ascii_character = game_self.ascii_map.get_string_by_prop_name("snake_utf_8_head_1")
            if(int(snake_head.rendered_count) % 3 == 1): snake_head.ascii_character = game_self.ascii_map.get_string_by_prop_name("snake_utf_8_head_2")
            if(int(snake_head.rendered_count) % 3 == 2): snake_head.ascii_character = game_self.ascii_map.get_string_by_prop_name("snake_utf_8_head_3")
        ...
        def snake_head_collision_function(self,collision_with):
            ...
            if(collision_with[0].name == "food_nerf_garlic"):
                ...
                n = 2
                i = 0
                for o in self.parent_class_instance.child_objects:
                    if o.name != "snake_utf_8_head" and i < n:
                        i+=1
                        self.parent_class_instance.child_objects.remove(o)
            ...
            if(collision_with[0].name == "food_powerup_portal"):
                for o in Object._instances:
                    ...
                    if o.name == "food_powerup_portal" and o != collision_with[0]:
                        self.point_3d.x = o.point_3d.x
                        self.point_3d.y = o.point_3d.y
                        random_position(o)
        ...
        def food_collision_function(self,collision_with):
            if(collision_with[0].name == "game_utf_8_border"):
        ...
        food.collision_function = food_collision_function
                ...
                if obj.collidable == True :
                    ...
                    if(len(obj.collision_with) > 0):
                        if(obj.parent_class_instance.collision_function != None):
                            ...
                            obj.parent_class_instance.collision_function(obj, obj.collision_with)
