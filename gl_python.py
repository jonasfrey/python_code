...
def main():
    # glfw is graphics library frame work which helps with setting up windows for opengl usage
    if not glfw.init():
        return
    ...
    # 32 bit unsigned float 
    glClearColor(
        1.0, # light intensity 0-1 red 
        0.5, # light intensity 0-1 red
        0.0, # light intensity 0-1 red
        1.0 # light intensity 0-1 transparency
        )
