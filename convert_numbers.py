...
def rjust(s_string, n_characters):
    return '{s:{c}>{n}}'.format(s=s_string,n=n_characters,c='_')
...
class Polynom:
    ...
    def _get_formatted_string_by_base(self, n_base):
        ...
        return rjust(s_for_base, n_rjust)+" : "+ rjust(self._dec_to_base(self.n_decimal, n_base), n_binstrlen)+"\n"
